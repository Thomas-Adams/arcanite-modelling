...
/**
 * Entry point of the 'GenerateService' generation module.
 *
 * @generated
 */
public class GenerateService extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/eclipse/acceleo/module/sample/main/generateService";
     ...
     * @generated
     */
    public GenerateService(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public GenerateService(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                GenerateService generator = new GenerateService(modelURI, folder, arguments);
