...
public class CmsAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected CmsSwitch<Adapter> modelSwitch =
		new CmsSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.enargit.cms.BasicEntity <em>Basic Entity</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.enargit.cms.ContentType <em>Content Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
